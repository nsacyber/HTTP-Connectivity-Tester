...
Function Get-WDSSConnectivity() {
    ...
    $data.Add([pscustomobject]@{ TestUrl = 'https://c.urs.microsoft.com'; StatusCode = 403; })
	$data.Add([pscustomobject]@{ TestUrl = 'https://urs.microsoft.com' ; StatusCode = 403; })
    $data.Add([pscustomobject]@{ TestUrl = 'https://urs.smartscreen.microsoft.com'; StatusCode = 404; })
    $data.Add([pscustomobject]@{ TestUrl = 'https://t.urs.microsoft.com'; StatusCode = 403; })
    $data.Add([pscustomobject]@{ TestUrl = 'https://ars.smartscreen.microsoft.com'; StatusCode = 404; })
    $data.Add([pscustomobject]@{ TestUrl = 'https://apprep.smartscreen.microsoft.com'; StatusCode = 404; })
	$data.Add([pscustomobject]@{ TestUrl = 'https://feedback.smartscreen.microsoft.com'; StatusCode = 403; })
    $data.Add([pscustomobject]@{ TestUrl = 'https://nav.smartscreen.microsoft.com'; StatusCode = 404; })
    $data.Add([pscustomobject]@{ TestUrl = 'https://nf.smartscreen.microsoft.com'; StatusCode = 404; })
