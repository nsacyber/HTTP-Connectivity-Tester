...
Function Get-WindowsAnalyticsUpdateComplianceConnectivity() {
    ...
    #$data.Add([pscustomobject]@{ TestUrl = 'https://v10.vortex-win.data.microsoft.com'; StatusCode = 200; }) # repeat from above
    #$data.Add([pscustomobject]@{ TestUrl = 'https://settings-win.data.microsoft.com'; StatusCode = 200; }) # repeat from above
    #$data.Add([pscustomobject]@{ TestUrl = 'https://watson.telemetry.microsoft.com'; StatusCode = 200; }) # repeat from above
    #$data.Add([pscustomobject]@{ TestUrl = 'https://oca.telemetry.microsoft.com'; StatusCode = 200; }) # repeat from above
