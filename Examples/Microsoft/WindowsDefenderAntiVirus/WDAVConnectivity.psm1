...
Function Get-WDAVConnectivity() {
    ...
    $data.Add(@{ TestUrl = 'https://wdcp.microsoft.com'; UrlPattern='https://*.wdcp.microsoft.com'; ExpectedStatusCode = 503; Description = 'Windows Defender Antivirus cloud-delivered protection service, also referred to as Microsoft Active Protection Service (MAPS). Used by Windows Defender Antivirus to provide cloud-delivered protection.'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose }) # cloud-delivered protection service aka MAPS https://cloudblogs.microsoft.com/enterprisemobility/2016/05/31/important-changes-to-microsoft-active-protection-service-maps-endpoint/
    ...
    # Not expected status, but does exist. VirusTotal also captures a 200
    #==============================
    ...
    #000/200###01/29/2021###_$data.Add(@{ TestUrl = 'https://delivery.mp.microsoft.com'; UrlPattern='https://*.delivery.mp.microsoft.com'; Description = 'MU / WU - Security intelligence and product updates.'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose })
    #000/200###01/29/2021###_$data.Add(@{ TestUrl = 'https://windowsupdate.com'; UrlPattern='https://*.windowsupdate.com'; Description = 'MU / WU - Security intelligence and product updates.'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose })
    #200/200###01/29/2021###_
    $data.Add(@{ TestUrl = 'https://update.microsoft.com'; UrlPattern='https://*.update.microsoft.com'; Description = 'MU / WU - Security intelligence and product updates.'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose })
    #==============================
    ...
    #"You do not have permission to view this directory or page."   I do get a 200 from VirusTotal results
    #403/200###01/25/2021###_
    ...
    #404/200###01/29/2021###_$data.Add(@{ TestUrl = 'https://adldefinitionupdates-wu.azurewebsites.net/test'; ExpectedStatusCode = 200; Description = 'Alternative to https://adl.windows.com which allows the compatibility update to receive the latest compatibility data from Microsoft'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose })
    #404/200###01/29/2021###_$data.Add(@{ TestUrl = 'https://adldefinitionupdates-wu.azurewebsites.net/ping'; ExpectedStatusCode = 200; Description = 'Alternative to https://adl.windows.com which allows the compatibility update to receive the latest compatibility data from Microsoft'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose })
    #404/200###01/29/2021###_$data.Add(@{ TestUrl = 'https://adldefinitionupdates-wu.azurewebsites.net/check'; ExpectedStatusCode = 200; Description = 'Alternative to https://adl.windows.com which allows the compatibility update to receive the latest compatibility data from Microsoft'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose })
