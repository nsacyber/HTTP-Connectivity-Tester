...
# 1. import this file:
# Import-Module .\WDAVConnectivity.ps1
...
Function Get-WDAVConnectivity() {
    ...
    $data.Add([pscustomobject]@{ TestUrl = 'https://update.microsoft.com'; StatusCode = 200; Description = '*.update.microsoft.com. Microsoft Update Service (MU). Signature and product updates.'; IgnoreCertificateValidationErrors=$true })
