...
Function Get-WindowsAnalyticsUpdateComplianceConnectivity() {
    ...
    $data.Add(@{ TestUrl = 'https://ceuswatcab01.blob.core.windows.net'; ExpectedStatusCode = 400; Description = 'Windows Error Reporting (WER) required for Device Health and Update Compliance AV reports in Windows 10 1809 and later. Not used by Upgrade Readiness. Central US data center #1.'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose })
    $data.Add(@{ TestUrl = 'https://ceuswatcab02.blob.core.windows.net'; ExpectedStatusCode = 400; Description = 'Windows Error Reporting (WER) required for Device Health and Update Compliance AV reports in Windows 10 1809 and later. Not used by Upgrade Readiness. Central US data center #2.'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose })
    $data.Add(@{ TestUrl = 'https://eaus2watcab01.blob.core.windows.net'; ExpectedStatusCode = 400; Description = 'Windows Error Reporting (WER) required for Device Health and Update Compliance AV reports in Windows 10 1809 and later. Not used by Upgrade Readiness. Eastern US data center #1.'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose })
    $data.Add(@{ TestUrl = 'https://eaus2watcab02.blob.core.windows.net'; ExpectedStatusCode = 400; Description = 'Windows Error Reporting (WER) required for Device Health and Update Compliance AV reports in Windows 10 1809 and later. Not used by Upgrade Readiness. Eastern US data center #2.'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose })
    $data.Add(@{ TestUrl = 'https://weus2watcab01.blob.core.windows.net'; ExpectedStatusCode = 400; Description = 'Windows Error Reporting (WER) required for Device Health and Update Compliance AV reports in Windows 10 1809 and later. Not used by Upgrade Readiness. Western US data center #1.'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose })
    $data.Add(@{ TestUrl = 'https://weus2watcab02.blob.core.windows.net'; ExpectedStatusCode = 400; Description = 'Windows Error Reporting (WER) required for Device Health and Update Compliance AV reports in Windows 10 1809 and later. Not used by Upgrade Readiness. Western US data center #2.'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose })
