...
Function Get-WindowsAnalyticsUpdateComplianceConnectivity() {
    ...
    $data.Add(@{ TestUrl = 'https://v10c.events.data.microsoft.com'; ExpectedStatusCode = 404; Description = 'Connected User Experience and Diagnostic component endpoint for use with Windows 10 releases that have the September 20/26 2018 updates installed: KB4457127 (1607), KB4457141 (1703), KB4457136 (1709), KB4458469 (1803).'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose })
