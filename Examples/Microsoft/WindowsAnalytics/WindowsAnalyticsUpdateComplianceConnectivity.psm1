...
Function Get-WindowsAnalyticsUpdateComplianceConnectivity() {
    ...
    $data.Add(@{ TestUrl = 'https://v10c.events.data.microsoft.com'; ExpectedStatusCode = 404; Description = 'Connected User Experience and Diagnostic component endpoint for use with Windows versions that have KB4458469 installed'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose })
