...
Function Get-WDATPConnectivity() {
    ...
    if ($UrlType.ToLower() -in @('all','endpoint')) {
        ...
        $data.Add(@{ TestUrl = 'https://us-v20.events.data.microsoft.com/ping'; ExpectedStatusCode = 404; Description='WDATP event channel for 1803+'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose }) # 1803+
        #
        ###200/200###01/25/2021###_
        ...
        ###200/200###01/25/2021###_
        $data.Add(@{ TestUrl = 'https://us.vortex-win.data.microsoft.com/ping'; Description='WDATP data channel.'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose }) # might be repeat status for https://us.vortex-win.data.microsoft.com/collect/v1
        #
        #-------- Commented Out START------------------------------------------------------------------------------------------------------------
