...
Function Get-WDSSConnectivity() {
    ...
    $data.Add(@{ TestUrl = 'https://unitedstates.smartscreen.microsoft.com'; UrlPattern='https://unitedstates.smartscreen.microsoft.com'; ExpectedStatusCode = 404; Description = 'SmartScreen URL used by Internet Explorer (iexplore.exe), Edge (MicrosoftEdge.exe)'; PerformBluecoatLookup=$PerformBluecoatLookup; Verbose=$isVerbose })
